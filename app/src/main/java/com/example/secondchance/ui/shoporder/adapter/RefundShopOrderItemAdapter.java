...
public class RefundShopOrderItemAdapter extends RecyclerView.Adapter<RefundShopOrderItemAdapter.RefundItemViewHolder> {

    private final List<ShopOrderProduct> productList;
    private final Context context;

    public RefundShopOrderItemAdapter(Context context, List<ShopOrderProduct> productList) {
