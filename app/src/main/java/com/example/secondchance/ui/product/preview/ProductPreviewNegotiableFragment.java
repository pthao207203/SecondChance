...
public class ProductPreviewNegotiableFragment extends Fragment {
    ...
    private void applyTypeStyle() {
        ...
        int backgroundColor = Color.parseColor("#FFF9E6");
        int textColor = Color.parseColor("#F59E0B");
    ...
    private void showPostSuccessDialog() {
        ...
        btnOk.setOnClickListener(v -> {
            dialog.dismiss();
            Navigation.findNavController(requireView()).navigate(R.id.action_previewNegotiable_to_productList);
        });
