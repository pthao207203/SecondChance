...
public class ConfirmCancelShopDialog extends DialogFragment {

    public static final String TAG = "ConfirmCancelDialogShop";
    ...
    public ConfirmCancelShopDialog(String orderId, OnCancelConfirmationListener listener) {
