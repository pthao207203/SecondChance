...
public class CancelFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Điều hướng trực tiếp từ fragment (không gọi parent)
    ...
    private void loadDummyData() {
        ...
        // Điều chỉnh theo constructor Order của bạn
        ...
        dummyOrderList.add(new Order("CANCELED002", "Vòng tay bạc", "₫ 100.000", "x1",
          ...
          false, null, null));
        dummyOrderList.add(new Order("CANCELED003", "Tranh sơn dầu", "₫ 300.000", "x1",
          "Đấu giá", "Đã hủy 19/6/2025", "Đã hủy", null, Order.OrderType.CONFIRMED_AUCTION,
          false, null, null));
