...
public class WalletReceivedHistoryAdapter extends RecyclerView.Adapter<WalletReceivedHistoryAdapter.VH> {
  ...
  public WalletReceivedHistoryAdapter(List<WalletHistoryItem> data) {
    this.data = data;
  }
